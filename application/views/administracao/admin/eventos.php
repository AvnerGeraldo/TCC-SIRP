...
<div class="container-fluid well">
	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 col-lg-offset-3 col-md-offset-3 col-sm-offset-3">
		<form name="frmEvento" method="POST" class="form-horizontal">
			<div class="form-group">
				<label for="txtEvento" class="col-lg-2 col-md-2 col-sm-2 col-xs-4">Evento:</label>
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
					<input type="text" name="txtEvento" id="txtEvento" placeholder="Escreve aqui o evento" class="form-control">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
					<input type="text" name="txtDataHora" id="txtDataHora" class="form-control">
				</div>
