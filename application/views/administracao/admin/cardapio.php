		...
		<form name="frmProduto"  action="<?=base_url('Cardapio/cadastrar')?>" method="post" enctype="multipart/form-data" class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
					<img src="<?=( isset($imagem) && !empty($imagem) ? $imagem : base_url('web-files/imagens/stuffs/image-off.jpg'))?>" id="imagemProduto" alt="<?=( isset($nomeCardapio) ? $nomeCardapio : 'Imagem do Produto' )?>" width="150" height="150" class="img-rounded">
				</div>
